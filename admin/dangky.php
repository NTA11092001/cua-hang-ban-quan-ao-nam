...
if (isset($_POST['dangky'])) {
	...
	$sql = "INSERT INTO tbl_admin(tentk,mk,admin_status) VALUE ('" . $taikhoan . "','" . $matkhau . "','1')";
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-6 col-lg-7 d-flex align-items-center">
					...
					<form action="" autocomplete="off" method="POST">
                        ...
                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Đã có tài khoản? <a href="login.php" style="color: #393f81;">Đăng Nhập</a>
